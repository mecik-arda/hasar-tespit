...
class DayaniklilikTesti(unittest.TestCase):
    ...
    def test_karanlik_gorsel_dayanikliligi(self):
        ...
        self.assertIsNotNone(sonuc, "Karanlik gorselde hasar tespiti None dondurmemeli")
    ...
    def test_gurultulu_gorsel_dayanikliligi(self):
        ...
        self.assertIsNotNone(sonuc, "Gurultulu gorselde hasar tespiti None dondurmemeli")
