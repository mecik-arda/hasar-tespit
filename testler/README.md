...
* **`test_adaptif_tta.py`:** OpenCV kalite analizini, gamma ve LAB-CLAHE varyant seçimini, geometrik kutu geri dönüşümünü, model-içi TTA füzyonunu ve bootstrap mAP50 kalibrasyon kriterlerini test eder.
